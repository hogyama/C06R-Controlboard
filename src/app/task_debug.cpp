...
void printHelp()
{
    serialWriteLine("$HELP,?=help,v=status,f=list,i+0-2=select,n=next,r=repeat,m=map,x+x=erase_file,X+X=erase_all_files,M+M=erase_maps,R=can_reset,s=can_start");
}
